...
**ClimateStudy** is a global, student-friendly climate and weather intelligence project by **ClimaVids**.
...
- 🌦️ Location-based weather and climate analysis
...
- API credits
- creator and embeddable tools
- referrals and partner credits
- voluntary support
...
Never publish credentials, wallet private keys, seed phrases, access tokens, database passwords or payment webhook secrets. See [SECURITY.md](SECURITY.md).

## About ClimaVids

ClimateStudy is developed under the **ClimaVids** brand by **Dr. Hossein Imanipour**, a climatology and climate-data specialist.

- YouTube: https://www.youtube.com/@ClimaVids
- GitHub: https://github.com/ClimaVids
- Weather platform: https://climavids-weather.onrender.com/

## License

Unless a file states otherwise, the source code in this repository is released under the **Apache License 2.0**. See [LICENSE](LICENSE).
